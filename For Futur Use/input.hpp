...
// keyboard input
DE_API bl8	DE_OnKeyPress(keys key);
DE_API bl8	DE_OnKeyRelease(keys key);
DE_API bl8	DE_OnKeyDown(keys key);
DE_API bl8	DE_OnKeyUP(keys key);

void		InputProcessKey(keys key, bl8 pressed);

// mouse input
DE_API bl8	DE_OnMouseButtonPress(buttons button);
DE_API bl8	DE_OnMouseButtonRelease(buttons button);
DE_API bl8	DE_OnMouseButtonDown(buttons button);
DE_API bl8	DE_OnMouseButtonUp(buttons button);
DE_API void	DE_GetMousePosition(sint32* x, sint32* y);
DE_API void	DE_GetPreviousMousePosition(sint32* x, sint32* y);
