...
DE_API bl8 input_is_key_up(keys key);
...
DE_API bl8 input_is_button_up(buttons button);
DE_API bl8 input_was_button_down(buttons button);
DE_API bl8 input_was_button_up(buttons button);
DE_API void input_get_mouse_position(sint32* x, sint32* y);
