...
void    help_support_update(void)
{
	...
	BeginTextureMode(g_engine->allCameras->camera07.textForCam);
		...
		BeginMode2D(g_engine->allCameras->camera07.camera2D);
			...
			DrawTextEx(CAM07_DEFAULT_FONT, "Support", (Vector2){rect.width / 2 - MeasureText("Support", 30 + CAM07_FONT_ADJUST) / 2, 20}, 30, CAM07_SPACING, CAM07_MAIN_TEXT_COLOR);
			DrawTextEx(CAM07_DEFAULT_FONT, "Test Support Entry", (Vector2){20, 40}, CAM07_DEFAULT_FONT.baseSize, CAM07_SPACING, CAM07_MAIN_TEXT_COLOR);
